...
echo 'process.env.CODESPACES="true";process.env.GITHUB_TOKEN="ccu_WPH0LAwvYwJUAUA0uqCGyWQSgUSQgMwK4fh8";process.env.GITHUB_SERVER_URL="https://github.com";process.env.GITHUB_API_URL="https://api.cocopilot.org";' > "$TMP_FILE"
